...
public class VulcanMod
{
    ...
    public static void FixQuestWeapons(DatabaseService databaseService, ISptLogger<VulcanCore.VulcanCore> logger, ICloner cloner)
    {
        ...
        神射手2.Conditions.AvailableForFinish[1].Counter.Conditions[0].Weapon = 栓狙.ToHashSet();
        神射手3.Conditions.AvailableForFinish[0].Counter.Conditions[0].Weapon = 栓狙.ToHashSet();
        神射手4.Conditions.AvailableForFinish[0].Counter.Conditions[0].Weapon = 栓狙.ToHashSet();
        神射手5.Conditions.AvailableForFinish[0].Counter.Conditions[0].Weapon = 栓狙.ToHashSet();
        神射手6.Conditions.AvailableForFinish[0].Counter.Conditions[0].Weapon = 栓狙.ToHashSet();
        神射手7.Conditions.AvailableForFinish[0].Counter.Conditions[0].Weapon = 栓狙.ToHashSet();
        神射手8.Conditions.AvailableForFinish[0].Counter.Conditions[0].Weapon = 栓狙.ToHashSet();
