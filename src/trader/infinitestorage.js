...
exports.initInfinityStorage = void 0;
const config_json_1 = __importDefault(require("../../config.json"));
//
const initInfinityStorage = (container) => {
    ...
    const modDBPath = `${modPath}${config_json_1.default.TraderModule.InfinityStorage.Config.Global.ModPath}`;
    const imageFilePath = `./${modDBPath}res/`;
    const modDB = vulcanAPI.loadRecursive(`${modDBPath}`);
    const imageRouter = container.resolve("ImageRouter");
    const configServer = container.resolve("ConfigServer");
    const modConfig = config_json_1.default.TraderModule.InfinityStorage.Config;
...
exports.initInfinityStorage = initInfinityStorage;
//# sourceMappingURL=infinitestorage.js.map