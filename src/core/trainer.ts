...
export const initScriptTrainer = (container: DependencyContainer) => {
    ...
    const scriptTrainerConfig = Config.CoreModule.ScriptTrainer.Config
    const lootConfig = configServer.getConfig(ConfigTypes.LOCATION)
    const deathConfig = configServer.getConfig(ConfigTypes.LOST_ON_DEATH)
