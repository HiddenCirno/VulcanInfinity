...
exports.initConsole = void 0;
const config_json_1 = __importDefault(require("../../config.json"));
//
const initConsole = (container) => {
    ...
    const modDBPath = `${modPath}${config_json_1.default.CoreModule.Console.Global.ModPath}`;
        ...
        if (getItemName(CacheItemID) != null) {
            if (CachePlayerID != undefined && saveServer.getProfile(CachePlayerID).characters.pmc.Info.Nickname != undefined) {
                if (createItemArr(CacheItemID, quantity).length > 0) {
                    mailSendService.sendLocalisedSystemMessageToPlayer(CachePlayerID, "4f99e88e87b6f0b04f5ac689", createItemArr(CacheItemID, quantity), [], 2592000);
