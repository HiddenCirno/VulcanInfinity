...
exports.sentGit = exports.initSystemGift = void 0;
const crypto_1 = __importDefault(require("crypto"));
const config_json_1 = __importDefault(require("../../config.json"));
//
const initSystemGift = (container) => {
    ...
    const modDBPath = `${modPath}${config_json_1.default.CoreModule.SystemGift.Global.ModPath}`;
...
exports.initSystemGift = initSystemGift;
const sentGit = (container, sessionId) => {
    const vulcanAPI = container.resolve("VulcanCommon");
    ...
    const GunPool = config_json_1.default.CoreModule.SystemGift.Config.GiftData.Global;
        ...
        for (var i = 0; i < clientDB.templates.handbook.Items.length; i++) {
            ...
            if (ItemData.ParentId == Tag) {
                Array.push({
                    ...
                    "upd": {
                        "StackObjectsCount": 1,
                        "SpawnedInSession": config_json_1.default.CoreModule.SystemGift.Config.GiftData.Global.FindInRaid
                    },
    ...
    //并非第一次登陆
        ...
        const intervalTime = config_json_1.default.CoreModule.SystemGift.Config.MinIntervalTime * 1000;
    ...
    if (sentmail == true) {
        ...
        //判定节日
        var specialDays = { mailkey: "", itempack: [], maxstoragetime: config_json_1.default.CoreModule.SystemGift.Config.GiftData.Special.StorageMaxTime };
        switch (SpecialDaysStr) {
            case "情人节":
                {
                    specialDays.mailkey = "SystemMessageFirstLoginWithValentine";
                    initRewardPack(节日奖励, config_json_1.default.CoreModule.SystemGift.Config.GiftData.Special[SpecialDaysStr]);
            ...
            default: {
                if (timer[sessionId].count >= 30 && timer[sessionId].count % 30 == 0) {
                    ...
                    initRewardPack(每月奖励, config_json_1.default.CoreModule.SystemGift.Config.GiftData.MonthlyGiftData);
                    specialDays.itempack = 每月奖励;
                    vulcanAPI.debug("初始化每月奖励");
                    specialDays.maxstoragetime = config_json_1.default.CoreModule.SystemGift.Config.GiftData.MonthlyGiftData.StorageMaxTime;
                }
                else if (timer[sessionId].count >= 7 && timer[sessionId].count % 7 == 0) {
                    specialDays.mailkey = WeeklyMessageID;
                    initRewardPack(每周奖励, config_json_1.default.CoreModule.SystemGift.Config.GiftData.WeeklyGiftData);
                    specialDays.itempack = 每周奖励;
                    vulcanAPI.debug("初始化每周奖励");
                    specialDays.maxstoragetime = config_json_1.default.CoreModule.SystemGift.Config.GiftData.WeeklyGiftData.StorageMaxTime;
                }
                else {
                    specialDays.mailkey = DailyMessageID;
                    initRewardPack(每日奖励, config_json_1.default.CoreModule.SystemGift.Config.GiftData.DailyGiftData);
                    specialDays.itempack = 每日奖励;
                    vulcanAPI.debug("初始化每日奖励");
                    specialDays.maxstoragetime = config_json_1.default.CoreModule.SystemGift.Config.GiftData.DailyGiftData.StorageMaxTime;
                }
            }
        }
        if (!firstlogin) {
...
exports.sentGit = sentGit;
//# sourceMappingURL=systemgift.js.map