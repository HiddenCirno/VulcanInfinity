...
exports.initTips = exports.initVulcanMod = void 0;
const ConfigTypes_1 = require("C:/snapshot/project/obj/models/enums/ConfigTypes");
const Traders_1 = require("C:/snapshot/project/obj/models/enums/Traders");
const config_json_1 = __importDefault(require("../../config.json"));
//
const initVulcanMod = (container) => {
    ...
    const modDBPath = `${modPath}${config_json_1.default.CoreModule.VulcanMod.Config.Global.ModPath}`;
    ...
    if (config_json_1.default.CoreModule.VulcanMod.Config.BotEdit.BossEdit) {
        vulcanAPI.log("正在生成BOSS……");
        initBotEdit();
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.DogTagGenerate.Active) {
        vulcanAPI.log("正在冲压狗牌……");
        applyAIDogTag();
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.HideoutEdit.Active) {
        vulcanAPI.log("正在修建地堡……");
        vulcanAPI.initArea(modDB.hideout.area);
        initAreaEdit();
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.Prestige.Active) {
        initPrestigeEdit();
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.KeyEdit.Active) {
        vulcanAPI.log("正在铸造钥匙……");
        initKeyEdit();
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.HideoutEdit.EnableRecipeEdit) {
        initRecipeEdit();
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.HideoutEdit.RevertHideout) {
        revertHideout();
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.HideoutEdit.EnableModRecipe) {
        vulcanAPI.log("正在打印配方……");
        vulcanAPI.initRecipe(modDB.hideout.recipe);
        vulcanAPI.initScavCase(modDB.hideout.scavcase);
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.Global.Container.Active) {
        vulcanAPI.log("正在整理箱子……");
        //THICC武器箱
        var containerconfig = config_json_1.default.CoreModule.VulcanMod.Config.Global.Container;
    ...
    if (config_json_1.default.CoreModule.VulcanMod.Config.BotEdit.EnableExtraLoot) {
        vulcanAPI.log("正在投放物资……");
        initLoot();
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.Misc.BTRSettings.Active) {
        btrExtend();
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.Misc.TransitSettings.Active) {
        transitExtend();
    }
    if (config_json_1.default.CoreModule.VulcanMod.Config.Misc.CultistCircleSettings.Active) {
        cultistCircleExtend();
    }
    initQuestLocale();
    initCollectorLocale();
    if (config_json_1.default.CoreModule.VulcanMod.Config.BotEdit.AddKabanInShoreline) {
    ...
    configServer.getConfig(ConfigTypes_1.ConfigTypes.INVENTORY).randomLootContainers["674098588466ebb03408b210"].rewardTplPool = { "a61ca5b36dd3e79f14996c2b": 1 };
    configServer.getConfig(ConfigTypes_1.ConfigTypes.INVENTORY).randomLootContainers["674098588466ebb03408b210"].rewardTypePool = null;
    configServer.getConfig(ConfigTypes_1.ConfigTypes.INVENTORY).randomLootContainers["674098588466ebb03408b210"].rewardCount = 1;
    ...
    */
    ...
    function transferSuitsToRagman() {
        const traderSuits = clientDB.traders[Traders_1.Traders.RAGMAN].suits;
    ...
    function applyAIDogTag() {
        const AIList = config_json_1.default.CoreModule.VulcanMod.Config.DogTagGenerate.Config.AIApplyList;
    ...
    function initKeyEdit() {
        const { MachineKeyList: KeyList, MachineKeyCount: KeyCount, ElectrCardList: CardList, ElectrCardCount: CardCount, ColorfulCardPrice: CardPrice, UseOrangeCardResource, ColorfulCardPriceOverride } = config_json_1.default.CoreModule.VulcanMod.Config.KeyEdit;
        ...
        if (ColorfulCardPriceOverride) {
            for (const card of Object.values(CardPrice)) {
                ...
                if (handbookItem)
                    handbookItem.Price = card.Handbook;
    ...
    function initBotEdit() {
        ...
        const reshalaChance = config_json_1.default.CoreModule.VulcanMod.Config.BotEdit.BossChance;
        //适配380的动态装备调整
        ...
        //#MC头兼容
        const MCHead = config_json_1.default.CoreModule.VulcanMod.Config.BotEdit.MCHeadData;
    ...
    function initPrestigeEdit() {
        ...
        for (var i = 0; i < prestigeConfig.length; i++) {
            if (config_json_1.default.CoreModule.VulcanMod.Config.Prestige.RemoveTransferLimit) {
                prestigeConfig[i].transferConfigs.stashConfig.filters.includedItems = ["54009119af1c881c07000029"];
            }
            prestigeConfig[i].transferConfigs.stashConfig.xCellCount = config_json_1.default.CoreModule.VulcanMod.Config.Prestige.PrestigeTransferSetting[0];
            prestigeConfig[i].transferConfigs.stashConfig.yCellCount = config_json_1.default.CoreModule.VulcanMod.Config.Prestige.PrestigeTransferSetting[1];
    ...
    function initLoot() {
        const LootData = config_json_1.default.CoreModule.VulcanMod.Config.BotEdit.LootData;
    ...
    function fixContainer() {
        ...
        //公文包容纳类型修复
        const BagArray = config_json_1.default.CoreModule.VulcanMod.Config.Global.BagData;
    ...
    function forceUnlockEventQuest() {
        ...
        const questcfg = configServer.getConfig(ConfigTypes_1.ConfigTypes.QUEST);
    ...
    function btrExtend() {
        ...
        if (config_json_1.default.CoreModule.VulcanMod.Config.Misc.BTRSettings.FreeDeliver) {
        ...
        for (let l in fencesettings.Levels) {
            ...
            level.DeliveryGridSize.x = config_json_1.default.CoreModule.VulcanMod.Config.Misc.BTRSettings.DeliverSpeace[0];
            level.DeliveryGridSize.y = config_json_1.default.CoreModule.VulcanMod.Config.Misc.BTRSettings.DeliverSpeace[1];
        }
    }
    function transitExtend() {
        ...
        for (let l in fencesettings.Levels) {
            const level = fencesettings.Levels[l];
            level.TransitGridSize.x = config_json_1.default.CoreModule.VulcanMod.Config.Misc.BTRSettings.DeliverSpeace[0];
            level.TransitGridSize.y = config_json_1.default.CoreModule.VulcanMod.Config.Misc.BTRSettings.DeliverSpeace[1];
        }
    }
    function cultistCircleExtend() {
        const hideoutsettings = configServer.getConfig(ConfigTypes_1.ConfigTypes.HIDEOUT);
        ...
        cultistCircle.maxRewardItemCount = config_json_1.default.CoreModule.VulcanMod.Config.Misc.CultistCircleSettings.MaxRewardCount;
        cultistCircle.rewardPriceMultiplerMinMax.min = config_json_1.default.CoreModule.VulcanMod.Config.Misc.CultistCircleSettings.RewardPriceMutipler[0];
        cultistCircle.rewardPriceMultiplerMinMax.max = config_json_1.default.CoreModule.VulcanMod.Config.Misc.CultistCircleSettings.RewardPriceMutipler[1];
        //clutistContainer._props.maxCount = Config.CoreModule.VulcanMod.Config.Misc.CultistCircleSettings.MaxInputCount
        clutistContainer._props.cellsH = config_json_1.default.CoreModule.VulcanMod.Config.Misc.CultistCircleSettings.CircleSpace[0];
        clutistContainer._props.cellsV = config_json_1.default.CoreModule.VulcanMod.Config.Misc.CultistCircleSettings.CircleSpace[1];
        //clutistContainer.MaxItemsCount = 10
        if (config_json_1.default.CoreModule.VulcanMod.Config.Misc.CultistCircleSettings.RemoveInputItemLimit) {
            clutistContainer._props.filters[0].ExcludedFilter = [];
            clutistContainer._props.filters[0].Filter = ["54009119af1c881c07000029"];
        }
    }
};
exports.initVulcanMod = initVulcanMod;
const initTips = (container) => {
    const vulcanAPI = container.resolve("VulcanCommon");
    const logger = container.resolve("WinstonLogger");
    const preSptModLoader = container.resolve("PreSptModLoader");
    const databaseServer = container.resolve("DatabaseServer");
...
exports.initTips = initTips;
//# sourceMappingURL=vulcanmod.js.map